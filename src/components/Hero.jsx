...
const Hero = ({ niche, onScrollToNiche }) => {
    ...
    return (
        <section
            className="relative flex flex-col md:flex-row items-center justify-between px-6 py-12 pt-32 md:pt-32 min-h-[85vh] md:min-h-[80vh] overflow-hidden"
            style={{
        ...
        >
            ...
            >
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onScrollToNiche}
                    className="md:hidden font-bold py-4 px-8 text-lg shadow-lg shadow-black/20 transition-all w-full text-white"
                    style={{
                        borderRadius: '100px',
                        border: '2px solid #84FE7B',
                        background: 'linear-gradient(81deg, rgba(62, 152, 1, 0.35) 23.07%, rgba(21, 50, 16, 0.35) 84.49%)'
